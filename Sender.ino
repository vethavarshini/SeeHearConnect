...
//------------------------------------------------------------Sensor
#define BLYNK_AUTH_TOKEN_SEND "8UMpZHPVl5NXSZmJgorkUzHOCMIzTs4M"
#define blynkSend     V1    // to receiver
#define blynkSendStr "V1"    // to receiver
#define blynkReceive  V0    // from receiver
